    ...
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-body p-4 text-center">
                ...
                <a href="{{ route('levels.index') }}" class="btn btn-outline-danger btn-lg px-5">
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center pb-2 bg-light p-3 rounded">
                            ...
                            <span class="font-weight-bold text-primary">{{ $level->id }}</span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center pb-2 bg-white p-3 rounded">
                            <span class="text-muted"><i class="fas fa-user-tag mr-2"></i>Level Kode</span>
                            <span class="font-weight-bold text-dark">{{ $level->level_code }}</span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center bg-light p-3 rounded">
                            <span class="text-muted"><i class="fas fa-layer-group mr-2"></i>Level Nama</span>
                            <span class="font-weight-bold text-dark">{{ $level->nama_level }}</span>
                        </div>
                    </div>
                </div>
            </div>
