...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-6 text-right">
            <button onclick="modalAction('{{ route('lombas.create') }}')" class="btn btn-success" >
                <i class="fa fa-plus"></i> Tambah Lomba
            </button>
        </div>
        @endif
    </div>
...
function createLombaCard(lomba) {
    ...
    var awalRegistrasi = lomba.awal_registrasi ? new Date(lomba.awal_registrasi).toLocaleDateString('id-ID', {day: '2-digit', month: '2-digit', year: 'numeric'}) : '-';
    var akhirRegistrasi = lomba.akhir_registrasi ? new Date(lomba.akhir_registrasi).toLocaleDateString('id-ID', {day: '2-digit', month: '2-digit', year: 'numeric'}) : '-';
