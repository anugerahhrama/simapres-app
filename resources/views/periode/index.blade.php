        ...
        <div class="card-header" style="background: white; border-bottom: 1px solid #e2e8f0; padding: 15px 20px;">
            <div class="d-flex justify-content-between align-items-center pb-3 border-bottom">
                <div class="form-group mb-0 mr-3">
                    <select class="form-control" id="periode_id" name="periode_id" style="min-width: 180px;">
                ...
                <div>
                    <button onclick="modalAction('{{ route('periodes.create') }}')" class="btn btn-primary"
                ...
                <div class="tab-content p-2">
                    <div class="tab-pane fade show active" id="all">
                        <div class="table-responsive" style="margin: 0 -1px;">
                            <table class="table table-hover" id="table_periode">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Tahun Ajaran</th>
